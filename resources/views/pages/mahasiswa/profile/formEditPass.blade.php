    ...
    <div class="card my-5" style="overflow-x: hidden !important">
      <div class="card-header pb-4 d-flex justify-content-between mb-lg-n4">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <form action="{{ route('new.password.mahasiswa') }}" method="post" id="myForm" enctype="multipart/form-data">
                @csrf
                {{-- nim penulis --}}
                <div class="form-group row mb-3 ">
                  ...
                  <div class="col-12 col-md-6">
                    <label for="nim" class="col-sm-5 col-form-label ">Nim Anda</label>
                    <input type="text" class="form-control" id="nim" name="nim" value="{{ $getDataMhs->nim }}"
