  ...
  <div class="card mb-5">
    <div class="card-header pb-4 d-flex justify-content-between mb-lg-n4">
      <div class="card-title mb-3">
        ...
        <small class="text-muted">Upload Jurnal Berkas Publikasi Anda</small>
    ...
    <div class="card mt-5">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
            <form action="{{ route('save.conference') }}" method="post" id="myForm" enctype="multipart/form-data">
            @csrf
            {{-- nim penulis --}}
            ...
            <div class="form-group row mb-3 ">
              <div class="col-12 col-md-6">
                ...
                <input type="date" class="form-control" id="tanggal_conference" name="tanggal_conference" value="{{ old("tanggal_conference") }}">
              ...
              <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control" id="lokasi_Conference" name="lokasi_Conference" value="{{ old("lokasi_Conference") }}">
            ...
            <div class="form-group row mb-3 ">
              <div class="col-12 col-md-6">
                ...
                <input type="date" class="form-control" id="tanggalPublikasi" name="tanggalPublikasi" value="{{ old("tanggalPublikasi") }}">
              ...
              <div class="col-12 col-md-6">
                ...
                <input type="url" class="form-control" id="naskah" name="link" value="{{ old("link") }}"
