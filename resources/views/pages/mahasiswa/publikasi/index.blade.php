  ...
  <div class="col-lg-12 mb-4 h-100">
    ...
    <div class="row card">
      ...
      <div class="col-lg-12 mt-3">
        {{-- button add --}}
        <a href="{{ route('form.conference') }}" class="btn btn-primary mb-3">
          Tambah Publikasi Conference
        </a>
            ...
            <tbody>
              @forelse ($dataPublikasiConference as $item)
                <tr>
                  ...
                  <td>
                    @if ($ambilStatus->isNotEmpty() && $ambilStatus->first()->status >= 4 && $ambilStatus->first()->status <= 5)
                      <a href="{{ route('publikasi.edit', $item->id) }}" class="btn btn-warning mb-2">Edit</a>
                      <form action="{{ route('publikasi.delete', $item->id) }}" method="post" class="d-inline">
                        @csrf
                        @method('delete')
    ...
    <div class="row card">
      ...
      <div class="table-responsive">
        {{-- button add --}}
        <a href="{{ route('form.jurnal') }}" class=" mt-3 btn btn-primary mb-3">
          Tambah Publikasi Jurnal
        </a>
