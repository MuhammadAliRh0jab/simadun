    ...
    <div class="col-lg-12 mb-4 h-100" id="ujian_proposan">
        <div class="card mb-3">
            <div class="card-header pb-4 d-flex justify-content-between mb-lg-n4">
                <div class="card-title mb-3">
                    <h2 class="mb-2">Ujian Kelayakan Disertasi</h2>
                    <small class="text-muted">Proses Ujian Kelayakan Disertasi. Tahap ini terdiri dari 4 tahapan utama yaitu
        ...
        <div class="card d-none" data-step="0">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('ujian.disertasi.store') }}" method="post" id="pendaftaran">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('usulan_penguji') is-invalid @enderror" multiple="multiple"
                                    ...
                                    @if ($disertasi)
                                        @if ($disertasi->penguji1_id)
                                            <option value="{{ $disertasi->penguji1_id }}" selected>
                                                {{ $disertasi->usulan_penguji1 }}
                                            </option>
                                        @endif
                                        @if ($disertasi->penguji2_id)
                                            <option value="{{ $disertasi->penguji2_id }}" selected>
                                                {{ $disertasi->usulan_penguji2 }}
                                            </option>
                                        @endif
                                        @if ($disertasi->penguji3_id)
                                            <option value="{{ $disertasi->penguji3_id }}" selected>
                                                {{ $disertasi->usulan_penguji3 }}
                                            </option>
                                        @endif
                                    @endif
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="url" class="form-control naskah @error('naskah') is-invalid @enderror" id="naskah" name="naskah"
                                    value="{{ old('naskah', $disertasi->file ?? '') }}" placeholder="Masukkan link GDrive naskah" required>
                                @error('naskah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7 col-md-9">
                                <p class="mb-0" id="penguji">
                                    @if ($disertasi)
                                        {{ $disertasi->usulan_penguji1 ?? '' }}
                                        @if ($disertasi->usulan_penguji2)
                                            , {{ $disertasi->usulan_penguji2 }}
                                        @endif
                                        @if ($disertasi->usulan_penguji3)
                                            , {{ $disertasi->usulan_penguji3 }}
                                        @endif
                                    @else
                                        Belum ada penguji
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7 col-md-9">
                                <a href="{{ $disertasi->file ?? '' }}" target="_blank" rel="noopener noreferrer">
                                    <p class="mb-0" id="naskah">{{ $disertasi->file ?? 'Belum ada naskah' }}</p>
                                </a>
                            </div>
                        </div>
        ...
        <div class="card d-none" data-step="2">
            <div class="card-header pb-4 d-flex justify-content-center mb-lg-n4">
                @if ($disertasi && $disertasi->status == 2)
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    @if ($disertasi && $disertasi->status == 2)
                        <div class="col-12">
                            ...
                            <div class="row mb-3 justify-content-center align-items-center">
                                ...
                                <div class="col-sm-7 col-md-5">
                                    <p class="mb-0" id="penguji1">{{ $disertasi->usulan_penguji1 ?? 'Belum ada' }}</p>
                                </div>
                            </div>
                            <div class="row mb-3 justify-content-center align-items-center">
                                <p class="col-sm-5 col-md-3 form-label mb-0"><b>Usulan Penguji 2</b></p>
                                <div class="col-sm-7 col-md-5">
                                    <p class="mb-0" id="penguji2">{{ $disertasi->usulan_penguji2 ?? 'Belum ada' }}</p>
                                </div>
                            </div>
                            @if ($disertasi && $disertasi->usulan_penguji3)
                                <div class="row mb-3 justify-content-center align-items-center">
                                    <p class="col-sm-5 col-md-3 form-label mb-0"><b>Usulan Penguji 3</b></p>
                                    <div class="col-sm-7 col-md-5">
                                        <p class="mb-0" id="penguji3">{{ $disertasi->usulan_penguji3 ?? 'Belum ada' }}</p>
                                    </div>
                                </div>
                            @endif
                            <div class="row mb-3 justify-content-center align-items-center">
                    ...
                    @elseif ($disertasi && $disertasi->status > 2)
                        <div class="col-12 col-md-6">
                            <div class="row mb-3">
                                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Tanggal Ujian</b></p>
                                <div class="col-sm-7 col-md-8">
                                    <p class="mb-0">{{ $jadwal_ujian ? \Carbon\Carbon::parse($jadwal_ujian->tanggal)->isoFormat('dddd, D MMMM Y') : 'Belum dijadwalkan' }}</p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Jam Ujian</b></p>
                                <div class="col-sm-7 col-md-8">
                                    <p class="mb-0">{{ $jadwal_ujian ? \Carbon\Carbon::parse($jadwal_ujian->jam)->format('H:i') : 'Belum dijadwalkan' }}</p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Ruangan Ujian</b></p>
                                <div class="col-sm-7 col-md-8">
                                    <p class="mb-0">{{ $jadwal_ujian->ruangan ?? 'Belum ditentukan' }}</p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Penguji 1</b></p>
                                <div class="col-sm-7 col-md-8">
                                    <p class="mb-0">{{ $jadwal_ujian->penguji1 ?? 'Belum ditentukan' }}</p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Penguji 2</b></p>
                                <div class="col-sm-7 col-md-8">
                                    <p class="mb-0">{{ $jadwal_ujian->penguji2 ?? 'Belum ditentukan' }}</p>
                                </div>
                            </div>
        ...
        @if ($disertasi && $disertasi->status == 4)
        ...
        @if ($disertasi && $disertasi->status > 3)
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-8">
                            <div class="row mb-4">
                                ...
                                <div class="">
                                    @if ($disertasi->nilai_penguji1 == 100)
                                    ...
                                    @endif
                                    @if ($disertasi->nilai_penguji2 == 100)
                                    ...
                                    @endif
                                    @if ($disertasi->penguji3_id)
                                        @if ($disertasi->nilai_penguji3 == 100)
                                        ...
                                        @endif
                                    @endif
                                    @if ($disertasi->nilai_promotor == 100)
                                    ...
                                    @endif
                                    @if ($disertasi->nilai_co_promotor1 == 100)
                                    ...
                                    @endif
                                    @if ($disertasi->nilai_co_promotor2 !== null)
                                        @if ($disertasi->nilai_co_promotor2 == 100)
                                        ...
                                        @endif
                                    @endif
                                    @if ($disertasi->nilai_kaprodi == 100)
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="">
                                    @if ($disertasi->komentar1)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar1) !!}, 1)'>
                                            <i class="ti ti-message me-2" id="penguji1"></i> Penguji 1
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar2)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar2) !!}, 2)'>
                                            <i class="ti ti-message me-2" id="penguji2"></i> Penguji 2
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar3)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar3) !!}, 3)'>
                                            <i class="ti ti-message me-2" id="penguji3"></i> Penguji 3
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar4)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar4) !!}, "Promotor")'>
                                            <i class="ti ti-message me-2" id="promotor"></i> Promotor
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar5)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar5) !!}, "Co-Promotor 1")'>
                                            <i class="ti ti-message me-2" id="co_promotor1"></i> Co-Promotor 1
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar7)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar7) !!}, "Co-Promotor 2")'>
                                            <i class="ti ti-message me-2" id="co_promotor2"></i> Co-Promotor 2
                                        </button>
                                    @endif
                                    @if ($disertasi->komentar6)
                                        <button class="btn btn-light m-1 komentar" data-bs-toggle="modal" data-bs-target="#modalComment"
                                            onclick='showk({!! json_encode($disertasi->komentar6) !!}, "Kaprodi")'>
                                            <i class="ti ti-message me-2" id="kaprodi"></i> Kaprodi
                                        </button>
                                    @endif
                                </div>
                            </div>
                            @if ($disertasi->status == 4)
                                <form action="{{ route('ujian.disertasi.revisi') }}" method="post" id="revisi">
                                    @csrf
                                    @method('patch')
                                    <h5 class="mt-3 mb-1"><b>Form Revisi Naskah</b></h5>
                                    <input type="hidden" name="id_pendaftaran" value="{{ $disertasi->id }}">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control naskah_revisi @error('naskah_revisi') is-invalid @enderror"
                                            id="naskah_revisi" name="naskah_revisi" value="{{ old('naskah_revisi') }}" placeholder="Masukkan link GDrive naskah"
                                            required>
                                        @error('naskah_revisi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group mb-3 text-end">
                                        <button type="submit" class="btn btn-primary btn-next naskah_revisi" id="naskah_revisi_submit">
                                            Submit
                                        </button>
                                    </div>
                                </form>
                            @elseif ($disertasi->status == 5)
                                <div class="row mb-3">
                                    ...
                                    <div class="">
                                        <a href="{{ $disertasi->file ?? '' }}" target="_blank" rel="noopener noreferrer">
                                            <p class="mb-0" id="naskah">{{ $disertasi->file ?? '' }}</p>
                                        </a>
                                    </div>
                                </div>
                            @elseif ($disertasi->status == 6)
                                ...
                                <div class="form-group mb-3 text-center">
                                    <a href="{{ route('ujian.tertutup') }}" class="btn btn-primary btn-next">
                                        Lanjutkan <i class="ti ti-arrow-right ms-2"></i>
                                    </a>
                                </div>
                            @endif
                        </div>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            window.showk = function(komentar, num) {
                console.log('Showing comment for:', num);
                $("#m_title").text("Komentar " + num);
                komentar = JSON.parse(komentar);
                showkomentars.setContents(komentar);
            };

            // Clean up Quill editor on modal close to prevent DOMNodeInserted errors
            $('#modalComment').on('hidden.bs.modal', function() {
                showkomentars.setContents([]); // Clear contents
            });
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            var progress = {{ $disertasi->status ?? 0 }};
            if (progress == 3) {
                progress = 2;
            } else if (progress > 4) {
                progress = 4;
            ...
            @if (!$disertasi)
                // Initialize Select2 for dosen search
                ...
                // Custom validation for minimum 2 selections
