...
@section('title', 'Ujian Seminar Hasil')
...
@section('content')
  <div class="col-lg-12 mb-4 h-100">
    ...
    @if ($semhas->status != 2 && $semhas->status != 4)
    ...
    <div class="row gap-3 gap-lg-0">
      ...
      <div class="col-lg-8">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">{{ $semhas->created_at }}, {{ $semhas->created_at->diffForHumans() }}</p>
                </div>
              </div>
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    {{ $semhas->usulan_penguji2 }}
                  </p>
                </div>
              </div>
              @if ($semhas->usulan_penguji3 && $semhas->usulan_penguji3 != '-')
                <div class="row mb-3">
                  <p class="col-sm-5 col-md-4 form-label mb-0"><b>Usulan Penguji 3</b></p>
                  <div class="col-sm-7 col-md-8">
                    <p class="mb-0">
                      {{ $semhas->usulan_penguji3 }}
                    </p>
                  </div>
                </div>
              @endif
              <div class="row mb-3">
                <p class="col-sm-5 col-md-4 form-label mb-0"><b>Berkas Naskah @if ($semhas->status == 5) (Revisi) @endif</b></p>
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ $semhas->file ?? '' }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0" id="naskah">{{ $semhas->file ?? '' }}</p>
                    </a>
                  </p>
                </div>
              </div>
        ...
        @if ($semhas->nilai_penguji1 || $semhas->nilai_penguji2 || $semhas->nilai_penguji3 || $semhas->nilai_promotor || $semhas->nilai_co_promotor1 || $semhas->nilai_co_promotor2 || $semhas->nilai_kaprodi)
          <div class="card mt-3">
            ...
            <div class="card-body">
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    @if ($semhas->nilai_penguji1)
                      @if ($semhas->nilai_penguji1 == 100)
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    @if ($semhas->nilai_penguji2)
                      @if ($semhas->nilai_penguji2 == 100)
                        <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                      @else
                        <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                      @endif
              ...
              @if ($jadwal_ujian && $jadwal_ujian->penguji3_id)
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7 col-md-8">
                    <p class="mb-0">
                      @if ($semhas->nilai_penguji3)
                        @if ($semhas->nilai_penguji3 == 100)
                          <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                        @else
                          <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                        @endif
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    @if ($semhas->nilai_promotor)
                      @if ($semhas->nilai_promotor == 100)
                        <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                      @else
                        <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                      @endif
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    @if ($semhas->nilai_co_promotor1)
                      @if ($semhas->nilai_co_promotor1 == 100)
                        <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                      @else
                        <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                      @endif
              ...
              @if ($mahasiswa->co_promotor2_id)
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7 col-md-8">
                    <p class="mb-0">
                      @if ($semhas->nilai_co_promotor2)
                        @if ($semhas->nilai_co_promotor2 == 100)
                          <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                        @else
                          <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                        @endif
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    @if ($semhas->nilai_kaprodi)
                      @if ($semhas->nilai_kaprodi == 100)
                        <span class="badge bg-label-success"><i class="ti ti-circle-check"></i> Layak</span>
                      @else
                        <span class="badge bg-label-danger"><i class="ti ti-circle-x"></i> Tidak Layak</span>
                      @endif
                ...
                <div class="col">
                  @if ($semhas->komentar1)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar1) !!}, 1)'>
                      <i class="ti ti-message me-2"></i> Penguji 1
                    </button>
                  @endif
                  @if ($semhas->komentar2)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar2) !!}, 2)'>
                      <i class="ti ti-message me-2"></i> Penguji 2
                    </button>
                  @endif
                  @if ($semhas->komentar3)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar3) !!}, 3)'>
                      <i class="ti ti-message me-2"></i> Penguji 3
                    </button>
                  @endif
                  @if ($semhas->komentar4)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar4) !!}, 4)'>
                      <i class="ti ti-message me-2"></i> Promotor
                    </button>
                  @endif
                  @if ($semhas->komentar5)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar5) !!}, 5)'>
                      <i class="ti ti-message me-2"></i> Co-Promotor 1
                    </button>
                  @endif
                  @if ($semhas->komentar7)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar7) !!}, 7)'>
                      <i class="ti ti-message me-2"></i> Co-Promotor 2
                    </button>
                  @endif
                  @if ($semhas->komentar6)
                    <button class="btn btn-light m-1" data-bs-toggle="modal" data-bs-target="#modalComment"
                            onclick='showk({!! json_encode($semhas->komentar6) !!}, 6)'>
        ...
        @if (!$semhas->nilai_kaprodi && ($jadwal_ujian && $jadwal_ujian->penilaian))
          <div class="card mt-3">
            <div class="card-header mb-0">
          ...
          <div class="card mt-3">
            ...
            <div class="card-body">
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <div class="mb-3">
                    @if ($semhas->jenis_ujian != 'tertutup' && $semhas->nilai_kaprodi == 100)
        ...
        @if (!$jadwal_ujian)
          <div class="card mt-3">
            ...
            <div class="card-body">
              <form action="{{ route('dosen.ujian.semhas.store', $semhas->id) }}" method="POST" id="penjadwalan">
                @csrf
                <div class="row mb-3">
        ...
        @if ($semhas->is_penilaian_done && $semhas->status < 6)
          <div class="card mt-3">
            <div class="card-header mb-0">
              ...
              <div class="row mb-3">
                <div class="col d-flex justify-content-center gap-2 my-3 w-100">
                  <button type="button" class="w-50 btn btn-warning"
                          @if ($semhas->status != 4) onclick="finalisasi('revisi', event)" @else disabled @endif>
                    <i class="ti ti-circle-x me-2"></i> <b>Revisi</b>
                  </button>
                  <button type="button" class="w-50 btn btn-success"
                          @if ($semhas->status != 4) onclick="finalisasi('layak', event)" @else disabled @endif>
                    <i class="ti ti-circle-check me-2"></i> <b>Layak</b>
                  </button>
                </div>
              </div>
      ...
      window.finalisasi = function (status, e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            axios.post("{{ route('dosen.ujian.semhas.finalisasi') }}", {
              _token: "{{ csrf_token() }}",
              _method: "PATCH",
              mahasiswa_id: "{{ $mahasiswa->id }}",
              semhas_id: "{{ $semhas->id }}",
              role: "kaprodi",
              jenis_ujian: "{{ $semhas->jenis_ujian }}",
              status: status,
            })
            .then((response) => {
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  window.location.href = "{{ route('dosen.ujian.semhas') }}";
                }
              });
            })
            .catch((error) => {
  ...
  <script>
    $(document).ready(function() {
      ...
      @if ($semhas->komentar6)
        ...
        const komentar = {!! $semhas->komentar6 !!};
        if (komentar) {
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#penjadwalan').submit(function(e) {
        ...
        Swal.fire({
          title: 'Apakah anda yakin?',
          text: "Anda akan menjadwalkan ujian seminar hasil mahasiswa ini!",
          icon: 'warning',
          customClass: {
            confirmButton: 'btn btn-success',
            cancelButton: 'btn btn-danger'
