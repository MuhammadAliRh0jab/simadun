    ...
    <div class="card mb-3">
      <div class="card-header pb-4 d-flex justify-content-between mb-lg-n4">
        <div class="card-title mb-3">
          <h2 class="mb-2">Tahap Ujian Kelayakan Disertasi</h2>
          <small class="text-muted">Tahap ini adalah tahap kedua dari ujian disertasi, ujian kelayakan disertasi</small>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
