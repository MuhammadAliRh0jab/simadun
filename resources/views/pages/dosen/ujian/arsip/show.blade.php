...
@section('title', 'Arsip Ujian Mahasiswa')
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ route('file', ['filename' => $ujian->proposal ?? 'null']) }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0">{{ $ujian->proposal ?? 'Tidak tersedia' }}</p>
                    </a>
                  </p>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ route('file', ['filename' => $ujian->semhas ?? 'null']) }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0">{{ $ujian->semhas ?? 'Tidak tersedia' }}</p>
                    </a>
                  </p>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ route('file', ['filename' => $ujian->publikasi ?? 'null']) }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0">{{ $ujian->publikasi ?? 'Tidak tersedia' }}</p>
                    </a>
                  </p>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ route('file', ['filename' => $ujian->disertasi ?? 'null']) }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0">{{ $ujian->disertasi ?? 'Tidak tersedia' }}</p>
                    </a>
                  </p>
                </div>
              </div>
                ...
                <div class="col-sm-7 col-md-8">
                  <p class="mb-0">
                    <a href="{{ route('file', ['filename' => $ujian->tertutup ?? 'null']) }}" target="_blank" rel="noopener noreferrer">
                      <p class="mb-0">{{ $ujian->tertutup ?? 'Tidak tersedia' }}</p>
                    </a>
                  </p>
                </div>
              </div>
