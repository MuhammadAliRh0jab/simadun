...
@section('title', 'Masuk ke SIMADUN')
@section('styles')
  <style>
    ...
    <div class="authentication-inner row">
      ...
      <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
          ...
          <!-- /Logo -->
          <h3 class="mb-1">Masuk ke SIMADUN</h3>
          <p class="mb-4">
          ...
          <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework"
            ...
            <div class="mb-3 fv-plugins-icon-container">
              ...
              <input type="text" class="form-control @if ($errors->has('creds')) is-invalid @endif" required
                id="no_induk" name="no_induk" value="{{ old('no_induk') }}" placeholder="Masukkan NIM/NIP/NIK"
                autofocus="">
            ...
            <div class="mb-3 form-password-toggle fv-plugins-icon-container">
              ...
              <div class="input-group input-group-merge has-validation">
                <input type="password" id="password"
                  class="form-control @if ($errors->has('creds')) is-invalid @endif" required name="password"
                  placeholder="············" aria-describedby="password">
                <span class="input-group-text cursor-pointer"><i class="ti ti-eye-off"></i></span>
              </div>
              @if ($errors->has('creds'))
                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                  {{ $errors->first('creds') }} </div>
              @endif
            </div>

            <div class="mb-3 d-flex justify-content-end">
              <a href="{{ route('halaman.lupa-password') }}" class="text-h-primary fw-bold">
                Lupa kata sandi?
              </a>
            </div>

            <button type="submit" class="btn btn-primary d-grid w-100 waves-effect waves-light">
              <span>Masuk <i class="ti ti-arrow-right"></i></span>
            </button>
          </form>
        </div>
      </div>
