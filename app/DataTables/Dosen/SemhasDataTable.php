...
use App\Models\Mahasiswa as Semhas;
...
class SemhasDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn(
                ...
                function ($row) {
                    $edit_route = null;
                    $delete_route = null;
                    $show_route = route('dosen.ujian.semhas.show', $row->pendaftaran_id);
                    $csrf = csrf_field();
