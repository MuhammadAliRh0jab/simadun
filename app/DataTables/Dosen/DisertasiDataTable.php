...
use App\Models\Mahasiswa as Disertasi;
...
class DisertasiDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn(
                ...
                function ($row) {
                    $edit_route = null;
                    $delete_route = null;
                    $show_route = route('dosen.ujian.disertasi.show', $row->pendaftaran_id);
                    $csrf = csrf_field();
     ...
     */
    public function query(Disertasi $model): QueryBuilder
    {
