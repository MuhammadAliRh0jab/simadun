...
use App\Models\Mahasiswa as Tertutup;
...
class TertutupDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('penilaian', function ($data) {
                if ($data->nilai_penguji1 != null && $data->nilai_penguji2 != null && $data->nilai_promotor != null && $data->nilai_co_promotor1 != null && ($data->co_promotor2_id == null || $data->nilai_co_promotor2 != null) && $data->nilai_kaprodi != null && $data->nilai_penguji_eks != null) {
                    $data->penilaian = 2;
                } elseif ($data->nilai_penguji1 != null || $data->nilai_penguji2 != null || $data->nilai_promotor != null || $data->nilai_co_promotor1 != null || $data->nilai_co_promotor2 != null || $data->nilai_kaprodi != null || $data->nilai_penguji_eks != null) {
                    $data->penilaian = 1;
                } else {
                    $data->penilaian = 0;
                }
            ...
            ->editColumn(
                ...
                function ($row) {
                    $edit_route = null;
                    $delete_route = null;
                    $show_route = route('dosen.ujian.tertutup.show', $row->pendaftaran_id);
                    $csrf = csrf_field();
